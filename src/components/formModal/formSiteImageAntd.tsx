...
interface ModalSiteImageAntd {
  openMSI: boolean
  setOpenMSI: React.Dispatch<React.SetStateAction<boolean>>
  product?: ProductV2
}

export const ModalSiteImageAntd: FC<ModalSiteImageAntd> = ({ openMSI, setOpenMSI, product }) => {
  ...
  return (
    <Transition.Root show={openMSI} as={Fragment}>
      <Dialog as="div" className="relative z-30" initialFocus={cancelButtonRef} onClose={setOpenMSI}>
        <Transition.Child
          as={Fragment}
