...
const formPage = [
  { name: 'Add Page', href: 'add-page', current: false },
  // { name: 'Update Page ', href: 'update-page', current: false },
]

export const HeadingChildrenDashboard: FC<HeadingChildrenDashboard> = ({ title, site }) => {
  ...
  return (
    <div className="flex items-baseline justify-between py-6">
      <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">{title} {getQuery(asPath).length > 3 && <Button onClick={clickUpdate} type="dashed">Update</Button>} </h1>
